...
def build_prompt_from_json_paths(json_paths: list[str], custom_prompt: str) -> str:
    assert json_paths, "No message files found."
    ...
    return build_prompt(messages, custom_prompt)
...
def build_report_prompt(ctx, input_files):
    ...
    prompt_text = build_prompt_from_json_paths(json_paths, custom_prompt)
