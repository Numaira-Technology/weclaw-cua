    ...
    if _groups_config_means_all_groups(config.groups_to_monitor):
        ...
        if pending:
            print(
                ...
                "group the model marks as is_group."
            )
        ...
        if pending:
            ...
            print(
                ...
                'groups_to_monitor to [] or ["*"] to capture every group the model marks '
                "as is_group, or paste exact sidebar strings from the debug logs."
            )
